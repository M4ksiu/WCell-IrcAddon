...
namespace IRCAddon
{
    public class IrcAddonConfig
    {
        ...
        /// </summary>
        [Variable("UpdatedChannels")] public static string[] UpdatedChannelNames = new[] {"#ChannelName"};
        ...
        public static string[] Nicks = new[]
                                           {
                                               RealmServerConfiguration.RealmName, RealmServerConfiguration.RealmName + "2"
                                               , RealmServerConfiguration.RealmName + "3"
                                           };
